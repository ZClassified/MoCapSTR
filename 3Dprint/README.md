...
| :--- | :--- | :--- | :--- |
| **OV9281 Camera Enclosure**<br>*(per camera)* | - 1x `Cam-FRONT`<br>- 1x `Cam-MID`<br>- 1x `Cam-BACK-SHORT` *(or LONG)*<br>- 1x `Cam-BRACKET` | - 1x Innomaker OV9281 USB camera PCB + lens *(Tested: up to 120 FPS in free-run, strictly max 50 FPS in hardware-trigger mode due to bridge firmware)*<br>- 1x 2-Pin Micro Plug (e.g. JST 1.25mm 2-pin) for FSIN header | - **9x** M3 brass heat-set inserts<br>- **7x** M3 15mm screws (3x Front/Mid, 4x Mid/Back)<br>- **2x** M3 thumbscrews (10–25mm) or standard M3 screws for bracket |
...
| :--- | :--- | :--- | :--- |
| **OV9281 Kamera-Gehäuse**<br>*(pro Kamera)* | - 1x `Cam-FRONT`<br>- 1x `Cam-MID`<br>- 1x `Cam-BACK-SHORT` *(oder LONG)*<br>- 1x `Cam-BRACKET` | - 1x Innomaker OV9281 USB-Kamera inkl. Objektiv *(Getestet: bis 120 FPS im Free-Run, max. 50 FPS im Hardware-Trigger-Modus durch Bridge-Firmware)*<br>- 1x 2-Pin Mikro-Steckverbinder (z. B. JST 1.25mm 2-Pin) für FSIN-Pins | - **9x** M3 Einschmelzgewinde<br>- **7x** M3 15mm Schrauben (3x Front/Mid, 4x Mid/Back)<br>- **2x** M3 Rändelschrauben (10–25mm) oder M3 Schrauben für den Bügel |
